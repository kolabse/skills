...
[English](../../../README.md) | Русский | [Español](../es/README.md) | [Français](../fr/README.md) | [Deutsch](../de/README.md) | [Português (Brasil)](../pt-BR/README.md) | [日本語](../ja/README.md) | [Italiano](../it/README.md) | [한국어](../ko/README.md) | [简体中文](../zh-CN/README.md) | [Türkçe](../tr/README.md) | [Polski](../pl/README.md) | [Українська](../uk/README.md)
...
#### `maintain-work-plan` (экспериментальный)

Поддерживает постоянный упорядоченный план проекта со стабильными ID, необязательными желаемыми датами и зависимостями.

- При первом запуске определяет существующие пути плана и журнала, код проекта, часовой пояс и правила работы с календарём; сохраняет существующий Markdown.
- Работает в паре с `maintain-work-log`: проверяет завершение и сохраняет датированную запись в журнале до удаления выполненной работы из активного плана.
- При наличии разрешения синхронизирует задачи с датами с календарём, используя заголовки `[КОД ПРОЕКТА] Название задачи`; выявляет конфликты и дубликаты, сохраняет ручные правки.
- Вспомогательная программа только читает нормализованные данные, проверяет их и показывает предлагаемые изменения; календарного клиента в ней нет, завершение задач она не доказывает.

Устанавливается стандартными командами установки коллекции. Вызов:
